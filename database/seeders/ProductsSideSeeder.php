...
class ProductsSideSeeder extends Seeder
{
    ...
    public function run()
    {
        $sides = [
            [
                "name" => "humitas",
                'description' => 'Galette de maïs, oignons et basilic enveloppée dans une feuille de bananier cuite à la vapeur.',
                "quantity" => 1,
                "stock" => 0,
            ...
            [
                "name" => "dim sums",
                'description' => 'Raviole asiatique de choux chinois, oignons, carottes, shitakes et vermicelles de riz.',
                "quantity" => 1,
                "stock" => 0,
            ...
            [
                "name" => "onigiri",
                'description' => 'Boule de riz farcie au thon et mayonnaise maison.',
                "quantity" => 1,
                "stock" => 0,
